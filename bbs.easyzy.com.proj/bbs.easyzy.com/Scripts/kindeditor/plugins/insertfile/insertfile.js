KindEditor.plugin('insertfile', function(K) {
	...
	self.plugin.fileDialog = function(options) {
		...
		var html = [
			...
			'<input type="text" id="keUrl" name="url" class="ke-input-text" style="width:170px;" />&ensp;',
			...
			'<input type="text" id="keTitle" class="ke-input-text" name="title" value="" style="width:170px;" />',
			'</div>',
		    // iframe
			'<div class="ke-dialog-row">',
            '<input type="hidden" id="hdfFileType" value="*.zip;*.rar;*.doc;*.docx;*.xls;*.xlsx;*.ppt;*.htm;*.html;*.txt" />',
