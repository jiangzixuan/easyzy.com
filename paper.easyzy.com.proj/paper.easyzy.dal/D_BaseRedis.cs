        ...
        public static List<T_City> GetCities(int provinceId)
        {
            ...
            using (var client = RedisHelper.Instance.GetRedisClient(CacheCatalog.Base.ToString()))
            {
                if (client != null)
                {
                    ...
                    if (tempresult == null)
                    {
                        tempresult = D_Base.GetCities(provinceId);
        ...
        public static List<T_District> GetDistricts(int cityId)
        {
            ...
            using (var client = RedisHelper.Instance.GetRedisClient(CacheCatalog.Base.ToString()))
            {
                if (client != null)
                {
                    ...
                    if (tempresult == null)
                    {
                        tempresult = D_Base.GetDistricts(cityId);
                        if (tempresult != null && tempresult.Count > 0)
                        {
        ...
        public static List<T_School> GetSchools(int districtId)
        {
            ...
            using (var client = RedisHelper.Instance.GetRedisClient(CacheCatalog.Base.ToString()))
            {
                if (client != null)
                {
                    ...
                    if (tempresult == null)
                    {
                        tempresult = D_Base.GetSchools(districtId);
                        if (tempresult != null && tempresult.Count > 0)
                        {
        ...
        public static T_School GetSchool(int schoolId)
        {
            ...
            using (var client = RedisHelper.Instance.GetRedisClient(CacheCatalog.Base.ToString()))
            {
                if (client != null)
                {
                    ...
                    if (tempresult == null)
                    {
                        tempresult = D_Base.GetSchool(schoolId);
                        if (tempresult != null)
                        {
